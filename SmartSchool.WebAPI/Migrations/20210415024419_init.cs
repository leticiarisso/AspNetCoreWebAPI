...
namespace SmartSchool.WebAPI.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Registro", "Sobrenome", "Telefone" },
                values: new object[] { 1, "Lauro", 1, "Oliveira", null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Registro", "Sobrenome", "Telefone" },
                values: new object[] { 2, "Roberto", 2, "Soares", null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Registro", "Sobrenome", "Telefone" },
                values: new object[] { 3, "Ronaldo", 3, "Marconi", null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Registro", "Sobrenome", "Telefone" },
                values: new object[] { 4, "Rodrigo", 4, "Carvalho", null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "Nome", "Registro", "Sobrenome", "Telefone" },
                values: new object[] { 5, "Alexandre", 5, "Montanha", null });
